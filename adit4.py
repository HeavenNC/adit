...
aditmadzs = LineClient(authToken='EwbZFHY5bQWV8oHNv6N7.NJBaaPWX4ChwW2QkFbp+nW.rFE3ngXFeF+A5F0+fEhauOzAusjlCW6EbZHwvT2h+JM=')
...
ki = LineClient(authToken='EwJ5ZGjuQT3v5mGfJ6Y1.iqPpPFnwvkad61U6Am51Oq.Gf347c5IgpwMPLPHEogWnVQ6LOmsfhk7zdC7Y5xOpPc=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EwYx3OA4mJZVAYhD5ZE1.DqSI0BaMsesu/GmpEhDn0q.2XsR3c7tkJ5NNsFsUe989ad9+YV3ZBriYWECXwCKq74=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EwrcfEwlxghQ0SgC7pa3.NBtSpUx8FyWmnbWfZbh5KW.ri2b9eK1CFkN6BTH6lFxU1MixJYGrDG5bnw9LfI8rCA=')
...
staff = ["u9e36c0029c31e1c1d6c36a8a7c13ff37"]
...
def sendMentionFooter(to, text="", mids=[]):
    ...
    aditmadzs.sendMessage(to, textx, {'AGENT_NAME':'Creator', 'AGENT_LINK': 'http://line.me/ti/p/~syifaabyananta', 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + aditmadzs.getProfile().picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               url = 'https://line.me/ti/p/~syifaabyananta'
